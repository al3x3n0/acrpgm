...
namespace Delight
{
    public partial class InputField : UIImageView
    {
        ...
        static InputField()
        {
            ...
            dependencyProperties.Add(ShouldActivateOnSelectProperty);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.UI.InputField, InputField> ShouldActivateOnSelectProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.UI.InputField, InputField>("ShouldActivateOnSelect", x => x.InputFieldComponent, x => x.shouldActivateOnSelect, (x, y) => x.shouldActivateOnSelect = y);
        public System.Boolean ShouldActivateOnSelect
        {
            get { return ShouldActivateOnSelectProperty.GetValue(this); }
            set { ShouldActivateOnSelectProperty.SetValue(this, value); }
        }
